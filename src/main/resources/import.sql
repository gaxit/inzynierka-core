...
INSERT INTO userek (user_id,email,login,name,password,phonenumber,address_id,role_id) VALUES (42,'email1','test1','Testowy1','test','2345',3,42);
INSERT INTO userek (user_id,email,login,name,password,phonenumber,address_id,role_id) VALUES (43,'email2','test2','Testowy2','test','2345',3,2);
