...
INSERT INTO userek (user_id, email, login, name, password, phonenumber, address_id, role_id) VALUES (10001, 'mail1@mail.com', 'login1', 'imie1', 'login', 'nrTelefonu1', 10001, 10002);
INSERT INTO userek (user_id, email, login, name, password, phonenumber, address_id, role_id, sessionid) VALUES (10002, 'mail2@mail.com', 'user', 'imieUsera1', 'user', 'nrTelefonu2', 10002, 10002, 'sessionid1');
