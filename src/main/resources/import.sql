...
INSERT INTO userek (user_id, email, login, name, password, phonenumber, address_id, role_id, sessionid) VALUES (10002, 'mail2@mail.com', 'user', 'imieUsera1', 'user', 'nrTelefonu2', 10001, 10002, 'sessionid1');
INSERT INTO userek (user_id, email, login, name, password, phonenumber, address_id, role_id, sessionid) VALUES (10003, 'mail2@mail.com', 'admin', 'imie2', 'admin', 'nrTelefonu2', 10003, 10001, 'sessionid1');
...
INSERT INTO offer (offer_id, offername, area, description, floor, garage, price, address_id, estatetype_id, transactiontype_id) VALUES (10004, 'Oferta 4', 100, 'Opis4', '3', true, 200000, 10001, 10001, 10002);
